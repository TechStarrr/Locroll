...
export default function DashboardSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 z-50 bg-[#070d1f] flex flex-col py-8 font-['IBM_Plex_Mono'] text-xs uppercase tracking-widest border-r border-white/5">
